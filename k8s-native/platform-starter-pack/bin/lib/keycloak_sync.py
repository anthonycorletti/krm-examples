"""Reconcile local session lifetimes and application clients; preserve users and passwords."""
...
def main():
    ...
    with httpx.Client(
        ...
        response = client.put(
            ...
            json={
                key: realm[key]
                for key in ("accessTokenLifespan", "ssoSessionIdleTimeout", "ssoSessionMaxLifespan")
            },
        )
        response.raise_for_status()
