...
Planned: run deployment tests against an explicitly selected Kubernetes context. Colima is currently validated; remote deployment profiles still need implementation.
