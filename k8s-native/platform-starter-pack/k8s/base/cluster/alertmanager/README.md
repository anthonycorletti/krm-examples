...
Receives Prometheus alerts. The initial configuration has no external notification receiver. Configure and exercise delivery before relying on notifications.
