...
The demo realm issues 24-hour access tokens and caps SSO sessions at 24 hours. Browser credentials persist until expiry or explicit OIDC sign-out; no refresh-token renewal extends the deadline. Run bin/local-identity-sync to update these realm lifetimes and application clients. Existing tokens retain their original expiry; sign in again to receive the new lifetime.
