...
Serves operational dashboards. The initial resources provide the service; curated application dashboards and their end-to-end queries remain to be built.
