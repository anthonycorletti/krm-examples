...
The local stack has passed staged installation and readiness checks on Colima. Remote profiles remain pending. Environment profiles must preserve the two-namespace separation; concurrent preview environments need an explicit isolation design.
