...
Apply namespaces and this composition using server-side apply (large CRDs), wait for CRDs/controller readiness, then install apps/workflows. Local rendering is checked; EKS execution is pending.
